...
const InvoiceDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchInvoiceData = async () => {
      try {
        ...
        // Check if invoice number already exists in the data
        if (response.data.invoiceNumber) {
          setInvoiceNumber(response.data.invoiceNumber);
        } else {
          // Generate invoice number in format PRO-APR2825-01 RITESH
          const invNum = response.data.invoiceId;
          setInvoiceNumber(invNum);
          setInvoiceData((prev) => ({ ...prev, invoiceNumber: invNum }));

          // Try to save the invoice number to the database
          try {
            await axios.patch(
  ...
  const generateInvoiceNumber = () => {
    ...
    // Fixed sequence number - in a real app, this would come from the database
  ...
  const determineGSTType = () => {
    ...
    if (!userCode || !companyCode) return "";
  ...
  const handlePrint = () => {
    // console.log("Let's check the invoice status 👉", invoiceData.status);
              ...
              <div class="client-info">
                ...
                <div class="info-item">
                  ...
                  <div class="info-value">
                    ...
                    ${
                      invoiceData.status?.toLowerCase() === "paid" ||
                      invoiceData.status?.toLowerCase() === "completed"
                        ? "Paid"
                        : "Pending"
                    }
      ...
      >
        <div className="bg-indigo-600 text-white p-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="bg-indigo-500 px-4 py-2 rounded-lg text-sm font-medium">
              {invoiceNumber}
            </div>
          </div>
        </div>
